...
func NewConfig() (Config, error) {
	...
	flag.StringVar(&cfg.ServerAddr, "server-addr", ":8080", "server address [env:SERVER_ADDR]")
	...
	flag.StringVar(&cfg.DestDir, "dest-dir", "./data", "destination directory to store data [env:DEST_DIR]")
